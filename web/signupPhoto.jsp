...
<html>
    <head> <link rel="stylesheet" href="https://fonts.googleapis.com">
        ...
        <style>
            ...
            .wallpaper{
                background-image: url(" https://replicate.delivery/pbxt/uOanw88V925TExZnmfDflfu8ucWzqTNe7sVekbo6c53FOeEPE/output.png");
                z-index: -1;
                width: 50%;
                height: 100%;
                margin-left: 55%;
        ...
        <div class="allform">
            <div class="total">
                ...
                <form  id="myForm" method="POST" action="http://localhost:8080/photography/portfolio" enctype="multipart/form-data">
                    ...
                    %>
                    <h1>Welcome <%= name%></h1> 
                    <h3> Add at least 5 Wedding to your portfolio</h3>
                    <div class="container">
                        <div class="image">
                            <img class="profileimage" id="imgout" width="100%" height="100%"  src="" alt="Add Image" disabled/>
                        </div>
                        ...
                        <%
                            ...
                            } else if (error != null && error.equalsIgnoreCase(
                                    "failed")) {
                        ...
                        <input type="hidden" name="genre" value="wedding">
                        <br>
                ...
                <a class="next"href="signup_photo_portrait.jsp?user=<%= user%>&name=<%= name%>">Next > </a>
