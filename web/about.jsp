...
<html lang="en">
    ...
    <body>
        ...
        <header >
            ...
            <nav>
                <ul>
                    <li><button><a href="landingpage.jsp?user=<%= user%>&role=<%= role%>">Home</a></button></li>
        ...
        <section class="about-us">
            <div class="text">
                ...
                <div class="contactdiv">
                    <a href="contact.jsp?user=<%= user%>&role=<%= role%>" class="contact">Contact Us</a>
                </div>
            </div>
        </section>
        <div class="aboutteam">
            ...
            <div class="about">
                <div class="image">
                    <img src=" https://replicate.delivery/pbxt/bxeABDzG6xzNfkNKZk2xDIdHDCzw0qkfGTC6ZoLd9Ent8H5hA/output.png">
                </div>
                <div class="info">
            ...
            <div class="about">
                ...
                <div class="image">
                    <img src="https://replicate.delivery/pbxt/eoqafbhzpPgzqEZany7AMVFjbPM5JfD5kNKK5GKgiYs8pH5hA/output.png">

                </div>
            </div>
            <div class="about">
                <div class="image">
                    <img src=" https://replicate.delivery/pbxt/VYLEcd292fTeEURd0ceGYNCObyXNpQp8F3r2TgO7srx4PI5hA/output.png">
                </div>
                <div class="info">
            ...
            <div class="about">
                ...
                <div class="image">
                    <img src="https://replicate.delivery/pbxt/2NBtC0glZyrIIJBRRsatoPXjMSYc5s0HVlzgpM42CiEQHJPE/output.png">
                </div>
            </div>
            <div class="about">
                <div class="image">
                    <img src="https://replicate.delivery/pbxt/Djp24rMA3l7zAd4ZtCQfNxt3uPSeQ0DN2eXNjnMeif1oEjkHC/output.png">
                </div>
                <div class="info">
            ...
            <div class="about">
                ...
                <div class="image">
                    <img src="https://replicate.delivery/pbxt/VkQasHgjP84lFFL2m0Hz47JeRXCCaSzOVLY7tO0dJeZKjk8QA/output.png">
                </div>
            </div>
        </div>
