<%-- 
    Document   : photo_comr
    Created on : 17 May, 2023, 3:02:15 AM
    Author     : sohel
--%>
...
<html>
    <head> <link rel="stylesheet" href="https://fonts.googleapis.com">
        ...
        <style>
            ...
            body{
                ...
                background: linear-gradient(90deg, rgba(240,248,249,1) 0%, rgba(181,200,194,1) 100%);
            }
            ...
            .wallpaper{
                background-image: url("https://replicate.delivery/pbxt/Pduk2RSCIgbpGV96j48kMSePZlYuSSSVMzpTotJeuSHHLU8QA/output.png");
            ...
            .allform{
                ...
                margin-right: 450px;
                color: #161d27;
                box-shadow: 0 0 10px #546833;
                backdrop-filter: blur(20px);
                border:1px solid  #546833;
                border-radius: 60px;
                margin-left: 400px;
                margin-top: 25px;
                width: 800px;
    ...
    <body>
        ...
        <div class="allform">
            <div class="total">
                <a class="next"href="signup_photo_travel.jsp?user=<%= user%>&name=<%= name%>">previous</a>
                ...
                <form  id="myForm" method="POST" action="http://localhost:8080/photography/portfolio" enctype="multipart/form-data">
                    ...
                    <h3> Add at least 5 Commercial Photos to your portfolio</h3>
                    <div class="container">
                        <div class="image">
                        ...
                        <input type="hidden" name="genre" value="commercial">
                        <br>
                ...
                <a class="next"href="signup_photo_event.jsp?user=<%= user%>&name=<%= name%>">Next</a>
