<%-- 
    Document   : photo_travel
    Created on : 17 May, 2023, 2:35:57 AM
    Author     : sohel
--%>
...
<html>
    <head> <link rel="stylesheet" href="https://fonts.googleapis.com">
        ...
        <style>
            ...
            .wallpaper{
                background-image: url("https://replicate.delivery/pbxt/WPJNNf8rfoqUNkhlb0hcwniffLSzgG5qIv737lrD7psBFQxDB/output.png");
    ...
    <body>
        ...
        <div class="allform">
            <div class="total">
                <a class="next"href="signup_photo_portrait.jsp?user=<%= user%>&name=<%= name%>">previous</a>

                <form  id="myForm" method="POST" action="http://localhost:8080/photography/portfolio" enctype="multipart/form-data">
                    <h1>Welcome <%= name%></h1>  
                    <h3> Add at least 5 Travel Photos to your portfolio</h3>
                    <div class="container">
                        <div class="image">
                        ...
                        <input type="hidden" name="genre" value="travel">
                        <br>
                ...
                <a class="next"href="signup_photo_commercial.jsp?user=<%= user%>&name=<%= name%>">Next</a>
