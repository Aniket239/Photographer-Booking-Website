...
<html>
    <head> <link rel="stylesheet" href="https://fonts.googleapis.com">
        ...
        <style>
            ...
            .wallpaper{
                background-image: url("https://replicate.delivery/pbxt/jdb57yGocjriKVgp6LJbt4EOUMLoXX5HffLO4C0Gwnkb5T8QA/output.png");
    ...
    <body>
        ...
        <div class="allform">
            <div class="total">
                <a class="next"href="signupPhoto.jsp?user=<%= user%>&name=<%= name%>">previous</a>

                <form  id="myForm" method="POST" action="http://localhost:8080/photography/portfolio" enctype="multipart/form-data">
                    <h1>Welcome <%= name%></h1>  
                    <h3> Add at least 5 Portraits to your portfolio</h3>
                    <div class="container">
                        <div class="image">
                        ...
                        <input type="hidden" name="genre" value="portrait">
                        <br>
                ...
                <a class="next"href="signup_photo_travel.jsp?user=<%= user%>&name=<%= name%>">Next</a>
